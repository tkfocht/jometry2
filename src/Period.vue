  ...
  const panels = [
    ...
    },
    {
      ...
      columns: [
        ...
        { label: 'BuzC', sortValueFunction: d => d['max']['BuzC'], attributeFunction: d => formatNumber(d['max']['BuzC'], 0, false)},
        { label: 'Buz$', sortValueFunction: d => d['max']['Buz$'], attributeFunction: d => formatNumber(d['max']['Buz$'], 0, false)},
        { label: 'DDF', sortValueFunction: d => d['max']['DDF'], attributeFunction: d => formatNumber(d['max']['DDF'], 0, false)},
    ...
    },
    {
      ...
      columns: [
        { label: 'Contestant', sortValueFunction: d => displayContestantIds.value.indexOf(d['Jometry Contestant Id']), attributeFunction: contestantLink},
        { label: 'Att', sortValueFunction: d => d['max']['Att'] === undefined ? -Infinity : d['max']['Att'], attributeFunction: d => formatNumber(d['max']['Att'], 0, false)},
        { label: 'Buz', sortValueFunction: d => d['max']['Buz'], attributeFunction: d => formatNumber(d['max']['Buz'], 0, false)},
        { label: 'Buz%', sortValueFunction: d => d['max']['Buz%'] === undefined ? -Infinity : d['max']['Buz%'], attributeFunction: d => formatNumber(d['max']['Buz%'], 1, false)},
        { label: 'BuzC', sortValueFunction: d => d['max']['BuzC'], attributeFunction: d => formatNumber(d['max']['BuzC'], 0, false)},
        ...
        { label: 'Time', sortValueFunction: d => d['max']['Timing'] === undefined ? -Infinity : d['max']['Timing'], attributeFunction: d => formatNumber(d['max']['Timing'], 1, false, true)},
        { label: 'Solo', sortValueFunction: d => d['max']['Solo'] === undefined ? -Infinity : d['max']['Solo'], attributeFunction: d => formatNumber(d['max']['Solo'], 1, false)},
        { label: 'AttV', sortValueFunction: d => d['max']['AttValue'] === undefined ? -Infinity : d['max']['AttValue'], attributeFunction: d => formatNumber(d['max']['AttValue'], 0, false)},
        { label: 'BuzV', sortValueFunction: d => d['max']['BuzValue'], attributeFunction: d => formatNumber(d['max']['BuzValue'], 0, false)},
        { label: 'BuzV%', sortValueFunction: d => d['max']['BuzValue%'] === undefined ? -Infinity : d['max']['BuzValue%'], attributeFunction: d => formatNumber(d['max']['BuzValue%'], 1, false)},
        { label: 'Buz$', sortValueFunction: d => d['max']['Buz$'], attributeFunction: d => formatNumber(d['max']['Buz$'], 0, false)},
        ...
        { label: 'TimeV', sortValueFunction: d => d['max']['TimingValue'] === undefined ? -Infinity : d['max']['TimingValue'], attributeFunction: d => formatNumber(d['max']['TimingValue'], 0, false, true)},
        { label: 'SoloV', sortValueFunction: d => d['max']['SoloValue'] === undefined ? -Infinity : d['max']['SoloValue'], attributeFunction: d => formatNumber(d['max']['SoloValue'], 0, false)},
      ]
    },
  ]
