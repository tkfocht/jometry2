  ...
  if (displayRounds.value === 2) {
    panels = [
      ...
      },
      {
        ...
        columns: [
          { label: 'Contestant', sortValueFunction: d => displayContestantIds.value.indexOf(d['Jometry Contestant Id']), attributeFunction: contestantLink},
          { label: 'JDDF', sortValueFunction: d => d['mean']['JDDF'], attributeFunction: d => formatNumber(d['mean']['JDDF'], 1, false)},
          { label: 'JDD+', sortValueFunction: d => d['mean']['JDD+'], attributeFunction: d => formatNumber(d['mean']['JDD+'], 2, false, true)},
          { label: 'JDD$', sortValueFunction: d => d['mean']['JDD$'], attributeFunction: d => formatNumber(d['mean']['JDD$'], 0, false)},
          { label: 'JBuz$', sortValueFunction: d => d['mean']['JBuz$'], attributeFunction: d => formatNumber(d['mean']['JBuz$'], 0, false)},
          { label: 'JFinal$', sortValueFunction: d => d['mean']['JFinal$'], attributeFunction: d => formatNumber(d['mean']['JFinal$'], 0, false)},
          { label: 'DJDDF', sortValueFunction: d => d['mean']['DJDDF'], attributeFunction: d => formatNumber(d['mean']['DJDDF'], 1, false)},
          { label: 'DJDD+', sortValueFunction: d => d['mean']['DJDD+'], attributeFunction: d => formatNumber(d['mean']['DJDD+'], 2, false, true)},
          { label: 'DJDD$', sortValueFunction: d => d['mean']['DJDD$'], attributeFunction: d => formatNumber(d['mean']['DJDD$'], 0, false)},
          { label: 'DJBuz$', sortValueFunction: d => d['mean']['DJBuz$'], attributeFunction: d => formatNumber(d['mean']['DJBuz$'], 0, false)},
      ...
      },
      {
        ...
        columns: [
          ...
          { label: '%', sortValueFunction: d => d['mean']['Buz%'] === undefined ? -Infinity : d['mean']['Buz%'], attributeFunction: d => formatNumber(d['mean']['Buz%'], 1, false)},
          ...
          { label: '%', sortValueFunction: d => d['mean']['BuzValue%'] === undefined ? -Infinity : d['mean']['BuzValue%'], attributeFunction: d => formatNumber(d['mean']['BuzValue%'], 1, false)},
      ...
      },
      {
        ...
        columns: [
          { label: 'Contestant', sortValueFunction: d => displayContestantIds.value.indexOf(d['Jometry Contestant Id']), attributeFunction: contestantLink},
          { label: 'JDDF', sortValueFunction: d => d['max']['JDDF'], attributeFunction: d => formatNumber(d['max']['JDDF'], 0, false)},
          { label: 'JDD+', sortValueFunction: d => d['max']['JDD+'], attributeFunction: d => formatNumber(d['max']['JDD+'], 2, false, true)},
          { label: 'JDD$', sortValueFunction: d => d['max']['JDD$'], attributeFunction: d => formatNumber(d['max']['JDD$'], 0, false)},
          { label: 'JBuz$', sortValueFunction: d => d['max']['JBuz$'], attributeFunction: d => formatNumber(d['max']['JBuz$'], 0, false)},
          { label: 'JFinal$', sortValueFunction: d => d['max']['JFinal$'], attributeFunction: d => formatNumber(d['max']['JFinal$'], 0, false)},
          { label: 'DJDDF', sortValueFunction: d => d['max']['DJDDF'], attributeFunction: d => formatNumber(d['max']['DJDDF'], 0, false)},
          { label: 'DJDD+', sortValueFunction: d => d['max']['DJDD+'], attributeFunction: d => formatNumber(d['max']['DJDD+'], 2, false, true)},
          { label: 'DJDD$', sortValueFunction: d => d['max']['DJDD$'], attributeFunction: d => formatNumber(d['max']['DJDD$'], 0, false)},
          { label: 'DJBuz$', sortValueFunction: d => d['max']['DJBuz$'], attributeFunction: d => formatNumber(d['max']['DJBuz$'], 0, false)},
      ...
      },
      {
        ...
        columns: [
          ...
          { label: '%', sortValueFunction: d => d['max']['Buz%'] === undefined ? -Infinity : d['max']['Buz%'], attributeFunction: d => formatNumber(d['mean']['Buz%'], 1, false)},
          { label: 'BuzC', sortValueFunction: d => d['max']['BuzC'], attributeFunction: d => formatNumber(d['max']['BuzC'], 1, false)},
          { label: '%', sortValueFunction: d => d['max']['BuzC%'], attributeFunction: d => formatNumber(d['max']['BuzC%'], 1, false)},
          ...
          { label: '%', sortValueFunction: d => d['max']['BuzValue%'] === undefined ? -Infinity : d['max']['BuzValue%'], attributeFunction: d => formatNumber(d['mean']['BuzValue%'], 1, false)},
          { label: 'Buz$', sortValueFunction: d => d['max']['Buz$'], attributeFunction: d => formatNumber(d['max']['Buz$'], 0, false)},
          { label: '%', sortValueFunction: d => d['max']['Buz$%'], attributeFunction: d => formatNumber(d['max']['Buz$%'], 1, false)},
    ...
    panels = [
      ...
      },
      {
        ...
        columns: [
          ...
          { label: 'DJBuz$', sortValueFunction: d => d['mean']['DJBuz$'], attributeFunction: d => formatNumber(d['mean']['DJBuz$'], 0, false)},
          { label: 'DJFinal$', sortValueFunction: d => d['mean']['DJFinal$'], attributeFunction: d => formatNumber(d['mean']['DJFinal$'], 0, false)},
          { label: 'TJDDF', sortValueFunction: d => d['mean']['TJDDF'], attributeFunction: d => formatNumber(d['mean']['TJDDF'], 1, false)},
          { label: 'TJDD+', sortValueFunction: d => d['mean']['TJDD+'], attributeFunction: d => formatNumber(d['mean']['TJDD+'], 2, false, true)},
          { label: 'TJDD$', sortValueFunction: d => d['mean']['TJDD$'], attributeFunction: d => formatNumber(d['mean']['TJDD$'], 0, false)},
          { label: 'TJBuz$', sortValueFunction: d => d['mean']['TJBuz$'], attributeFunction: d => formatNumber(d['mean']['TJBuz$'], 0, false)},
          { label: 'TJFinal$', sortValueFunction: d => d['mean']['TJFinal$'], attributeFunction: d => formatNumber(d['mean']['TJFinal$'], 0, false)},
          { label: 'FJ$', sortValueFunction: d => d['mean']['FJ$'], attributeFunction: d => formatNumber(d['mean']['FJ$'], 0, false)},
          { label: 'FJFinal$', sortValueFunction: d => d['mean']['FJFinal$'], attributeFunction: d => formatNumber(d['mean']['FJFinal$'], 0, false)},
        ]
      },
      ...
      },
      {
        ...
        columns: [
          ...
          { label: 'DJBuz$', sortValueFunction: d => d['max']['DJBuz$'], attributeFunction: d => formatNumber(d['max']['DJBuz$'], 0, false)},
          { label: 'DJFinal$', sortValueFunction: d => d['max']['DJFinal$'], attributeFunction: d => formatNumber(d['max']['DJFinal$'], 0, false)},
          { label: 'TJDDF', sortValueFunction: d => d['max']['TJDDF'], attributeFunction: d => formatNumber(d['max']['TJDDF'], 0, false)},
          { label: 'TJDD+', sortValueFunction: d => d['max']['TJDD+'], attributeFunction: d => formatNumber(d['max']['TJDD+'], 2, false, true)},
          { label: 'TJDD$', sortValueFunction: d => d['max']['TJDD$'], attributeFunction: d => formatNumber(d['max']['TJDD$'], 0, false)},
          { label: 'TJBuz$', sortValueFunction: d => d['max']['TJBuz$'], attributeFunction: d => formatNumber(d['max']['TJBuz$'], 0, false)},
          { label: 'TJFinal$', sortValueFunction: d => d['max']['TJFinal$'], attributeFunction: d => formatNumber(d['max']['TJFinal$'], 0, false)},
          { label: 'FJ$', sortValueFunction: d => d['max']['FJ$'], attributeFunction: d => formatNumber(d['max']['FJ$'], 0, false)},
          { label: 'FJFinal$', sortValueFunction: d => d['max']['FJFinal$'], attributeFunction: d => formatNumber(d['max']['FJFinal$'], 0, false)},
        ]
      },
