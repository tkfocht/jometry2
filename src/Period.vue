  ...
  var panels = [
    {
      ...
      columns: [
        ...
        { label: 'Lk', sortValueFunction: d => d['sum']['Locks'], attributeFunction: d => formatNumber(d['sum']['Locks'], 0, false)},
        { label: 'Cr', sortValueFunction: d => d['sum']['Crushes'], attributeFunction: d => formatNumber(d['sum']['Crushes'], 0, false)},
        { label: 'Ld', sortValueFunction: d => d['sum']['Leads'], attributeFunction: d => formatNumber(d['sum']['Leads'], 0, false)},
